...
from keras.layers import Dense, \
    Flatten, Dropout  # Dense layers are fully connected layers, Flatten layers flatten out multidimensional inputs
...
model.add(Dropout(0.2))
model.add(Dense(env.action_space.n, kernel_initializer='uniform',
